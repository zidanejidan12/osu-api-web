...
export declare namespace Multiplayer {
    ...
    namespace Room {
        ...
        namespace PlaylistItem {
            ...
            function getScores(this: API, item: {
                id: number;
                room_id: number;
            } | Multiplayer.Room.PlaylistItem, limit?: number, sort?: "score_asc" | "score_desc", cursor_string?: string): Promise<Multiplayer.Room.PlaylistItem.Scores>;
        }
        interface Leader {
        ...
        namespace Leader {
             ...
             */
            function getMultiple(this: API, room: number | Room): Promise<{
                leaderboard: Leader[];
         ...
         */
        function getOne(this: API, room: number | Room): Promise<Room>;
        /**
         ...
         */
        function getMultiple(this: API, type: "playlists" | "realtime", mode: "active" | "all" | "ended" | "participated" | "owned", limit?: number, sort?: "ended" | "created"): Promise<Room[]>;
    }
    ...
    namespace Match {
         ...
         */
        function getOne(this: API, match: Info["id"] | Info): Promise<Match>;
        /**
         ...
         */
        function getMultiple(this: API, query?: {
            /**
