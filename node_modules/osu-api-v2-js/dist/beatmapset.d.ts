...
export declare namespace Beatmapset {
    /**
    ...
    namespace Event {
        ...
        export type AnyDiscussionChange = DiscussionDelete | DiscussionRestoreORKudosuRecalculate | KudosuAllowORDenyORDiscussionPostDeleteORRestore | DiscussionLockORUnlock | IssueResolveOrReopen | KudosuGainORLost;
        ...
        export namespace Comment {
            interface WithModes extends Comment {
                modes: (keyof typeof Ruleset)[];
            }
            interface WithDiscussionidPostid extends Comment {
                beatmap_discussion_id: Discussion["id"] | null;
                beatmap_discussion_post_id: Discussion.Post["id"] | null;
            }
            interface WithDiscussionidPostidReason extends WithDiscussionidPostid {
                reason: string;
            }
            interface WithDiscussionidPostidNominatorsids extends WithDiscussionidPostid {
                nominator_ids: User["id"][];
            }
            interface WithDiscussionidPostidOldgenreNewgenre extends WithDiscussionidPostid {
                old: keyof typeof Genre;
                new: keyof typeof Genre;
            }
            interface WithDiscussionidPostidOldlanguageNewlanguage extends WithDiscussionidPostid {
                old: keyof typeof Language;
                new: keyof typeof Language;
            }
            interface WithDiscussionidPostidOldnsfwNewnsfw extends WithDiscussionidPostid {
                old: boolean;
                new: boolean;
            }
            interface WithDiscussionidPostidOldoffsetNewoffset extends WithDiscussionidPostid {
                old: number;
                new: number;
            }
            interface WithDiscussionidPostidOldtagsNewtags extends WithDiscussionidPostid {
                old: string;
                new: string;
            }
            interface WithDiscussionidPostidNewvotevotes extends WithDiscussionidPostid {
                new_vote: {
                    user_id: User["id"];
                    score: number;
                };
            ...
            interface WithDiscussionidPostidSourceuseridSourceuserusername extends WithDiscussionidPostid {
                source_user_id: User["id"];
                source_user_username: User["username"];
            }
            interface WithDiscussionidPostidBeatmapidBeatmapversionNewuseridNewuserusername extends WithDiscussionidPostid {
         ...
         */
        export function getMultiple(this: API, from?: {
            beatmapset?: Beatmapset["id"] | Beatmapset;
            user?: User["id"] | User;
            min_date?: Date;
            max_date?: Date;
        }, types?: Event["type"][], config?: Config): Promise<{
            events: Event.Any[];
            users: User.WithGroups[];
        }>;
        export {};
    }
    interface WithHype extends Beatmapset {
        hype: {
            current: number;
            required: number;
        } | null;
    }
    interface WithUserHype extends WithHype {
        user: User;
    }
    interface Extended extends WithHype {
        availability: {
    ...
    namespace Extended {
        ...
        interface WithBeatmap extends Extended {
            beatmaps: Beatmap.Extended[];
        }
        interface WithBeatmapPacktags extends Extended {
            beatmaps: Beatmap.Extended.WithMaxcombo[];
            pack_tags: string[];
        }
        /** @obtainableFrom {@link API.getBeatmapset} */
        interface Plus extends Extended, WithUserHype {
    ...
    namespace Discussion {
        interface WithStartingpost extends Discussion {
            starting_post: Post;
        }
        interface Post {
        ...
        namespace Post {
            ...
            function getMultiple(this: API, from?: {
                ...
                user?: User["id"] | User;
            }, types?: ("first" | "reply" | "system")[], config?: Config): Promise<{
        ...
        namespace Vote {
            ...
            function getMultiple(this: API, from?: {
                discussion?: Discussion["id"] | Discussion;
                vote_giver?: User["id"] | User;
                vote_receiver?: User["id"] | User;
            }, score?: 1 | -1, config?: Config): Promise<{
                votes: Vote[];
    ...
    function search(this: API, query?: {
        ...
        beatmapsets: Beatmapset.Extended.WithBeatmapPacktags[];
     ...
     */
    function lookup(this: API, beatmap: Beatmap["id"] | Beatmap): Promise<Beatmapset.Extended.Plus>;
    /**
     ...
     */
    function getOne(this: API, beatmapset: Beatmapset["id"] | Beatmapset): Promise<Beatmapset.Extended.Plus>;
}
